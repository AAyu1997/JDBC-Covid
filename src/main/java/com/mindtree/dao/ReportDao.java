 ...
 * while(rs.next()) {
 * 
 * String date=rs.getString("date"); stat=rs.getString("state"); String
 * city=rs.getString("city"); int
 * numberOfTestingDone=rs.getInt("numberOfTestingDone"); int
 * numberOfPositivePatient=rs.getInt("numberOfPositivePatient"); int
 * numberOfDiedPatient=rs.getInt("numberOfDiedPatient");
 * 
 * Corona report=new Corona();
 * 
 * report.setDate(date); report.setState(stat); report.setCity(city);
 * report.setNumberOfTestingDone(numberOfTestingDone);
 * report.setNumberOfPositivePatient(numberOfPositivePatient);
 * report.setNumberOfDiedPatient(numberOfDiedPatient);
 * 
